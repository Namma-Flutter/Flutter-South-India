...
export default function Expo() {
  return (
    <section id="expo" className="section-pad bg-[var(--surface-alt)] relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-[color:var(--foreground)]/60 text-base leading-relaxed mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            {features.map((item, i) => (
              ...
              >
                ...
                <p className="text-[color:var(--foreground)]/45 text-xs leading-relaxed">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
